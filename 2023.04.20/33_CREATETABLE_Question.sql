...
TOTAL NUMBER,
CONSTRAINTS PAY_CHE_TOT CHECK (TOTAL > 0)
);
...
CONSTRAINTS PAY_CHE_TIP CHECK (TOTAL_PRICE > 0),
CONSTRAINTS PAY_FOR_MNO FOREIGN KEY (MNO) REFERENCES PAYMENT (MNO),
CONSTRAINTS PAY_FOR_PNO FOREIGN KEY (PNO) REFERENCES PRODUCT (PNO)
);